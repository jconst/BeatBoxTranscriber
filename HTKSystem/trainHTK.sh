...
HInit -C needed/config -S train.scp -M hmm0/ proto
perl needed/createhmmdefs.pl hmm0

# HRest -C needed/config -I phones0.mlf -S train.scp -H hmm0/macros -H hmm0/hmmdefs -M hmm1/
...
# HERest -C needed/config -I phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H hmm3/macros -H hmm3/hmmdefs -M hmm4/ monophones0

# # create an sp model
# perl needed/makeSPmodel.pl hmm4

# # tie sp to center sil state
# HHEd -H hmm4/macros -H hmm5/hmmdefs -M hmm6 sil.hed monophones1
...
# HVite -l '*' -o SWT -b silence -C needed/config -a -H hmm8/macros -H hmm8/hmmdefs -i aligned.mlf -m -t 250.0 150.0 1000.0 -y lab -I words.mlf -S train.scp dict monophones1

# # two more passes of HERest
# HERest -C needed/config -I phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H hmm8/macros -H hmm8/hmmdefs -M hmm9/ monophones1
# HERest -C needed/config -I phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H hmm9/macros -H hmm9/hmmdefs -M hmm10/ monophones1

# # increase number of Gaussians in the Mixture model
# HHEd -H hmm10/macros -H hmm10/hmmdefs -M hmm11/ needed/mix.hed monophones0

# # two more passes of HERest
# HERest -C needed/config -I phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H hmm11/macros -H hmm11/hmmdefs -M hmm12/ monophones1
# HERest -C needed/config -I phones0.mlf -t 250.0 150.0 1000.0 -S train.scp -H hmm12/macros -H hmm12/hmmdefs -M hmm13/ monophones1
